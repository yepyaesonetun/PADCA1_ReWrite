package com.primeyz.padcassignment1.utils;
 ...
 */
public class CustomNestedScrollView extends FrameLayout implements NestedScrollingParent,
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(CustomNestedScrollView v, int scrollX, int scrollY,
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof CustomNestedScrollView.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }

        CustomNestedScrollView.SavedState ss = (CustomNestedScrollView.SavedState) state;
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        CustomNestedScrollView.SavedState ss = new SavedState(superState);
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Parcelable.Creator<CustomNestedScrollView.SavedState> CREATOR =
                new Parcelable.Creator<CustomNestedScrollView.SavedState>() {
                    @Override
                    public CustomNestedScrollView.SavedState createFromParcel(Parcel in) {
                        return new CustomNestedScrollView.SavedState(in);
                    }

                    @Override
                    public CustomNestedScrollView.SavedState[] newArray(int size) {
                        return new CustomNestedScrollView.SavedState[size];
                    }
                };
    }
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final CustomNestedScrollView nsvHost = (CustomNestedScrollView) host;
